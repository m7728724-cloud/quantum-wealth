...
commands = [
    ...
    'cd /root/quantum-wealth/backend && ./venv/bin/pip install fastapi uvicorn "passlib[bcrypt]" "python-jose[cryptography]" slowapi motor pymongo python-dotenv pydantic pydantic-settings',
